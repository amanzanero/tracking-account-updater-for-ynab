...
function RouteComponent() {
  return (
    <section className="flex w-full flex-1 justify-center bg-background px-4 py-5">
      <article className="prose flex-1 text-foreground">
        ...
        <ul>
          <li>
            We have no access to, nor do we collect, any bank credentials or account information
            from YNAB.
          </li>
          <li>
        ...
        <p className="text-foreground">
          Since no user data is collected or stored, there is no data usage beyond facilitating
          access to your YNAB account using the access token stored in your browser.
        </p>
